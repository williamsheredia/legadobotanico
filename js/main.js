...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (btnAbrirAporte && modalAporte) {
    ...
    // Manejo del formulario de DONACIONES
if (formDonaciones) {
  formDonaciones.addEventListener('submit', (e) => {
    ...
    .then(() => {
      ...
      // Al cerrar la ventana final, refresca la página manteniéndose en #aporta
...
// Manejo del formulario de VOLUNTARIADO
if (formVoluntarios) {
  formVoluntarios.addEventListener('submit', (e) => {
    ...
    .then(() => {
      ...
      // Al cerrar la ventana final, refresca la página manteniéndose en #voluntariado
    ...
    if (formVoluntarios) {
      formVoluntarios.addEventListener('submit', (e) => {
        ...
        .then(() => {
          ...
          `;
          document.getElementById('btn-cerrar-exito-vol').addEventListener('click', cerrarModalVol);
        })
        .catch((error) => console.error('Error al enviar el registro:', error));
      });
    }
